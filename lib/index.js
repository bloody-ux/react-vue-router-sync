...
function sync(history, router, historyOptions) {
  ...
  var syncFromHistory = function syncFromHistory(location) {
    ...
    var newPath = (0, _utils.stripBasename)((0, _utils.pathJoin)(basename, pathname) + search + hash, base);
  ...
  var syncToHistory = function syncToHistory() {
    ...
    var newPath = (0, _utils.stripBasename)((0, _utils.pathJoin)(base, fullPath), basename);
